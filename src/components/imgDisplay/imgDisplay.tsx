    ...
    return (
        <div className="w-full position-relative d-flex justify-content-center align-items-start">
            ...
            <div className={"w-100 position-absolute bottom-0 d-flex align-items-center justify-content-center h-50"}>
                <div className={"h-100 img-display-text p-4 text-center d-flex flex-column justify-content-start align-items-center"}>
                    <text className={"h6 bg-card-gray p-1"}>LOREM IPSUM</text>
                    <text className={"h2 serif-font"}>
