...
export function ColStaticDisplay({body, bottom}: any) {
    return (
        <div className={"d-flex flex-column w-100 border border-1 border-black border-top-0 serif-font fw-semibold pt-4"}>
