    ...
    return (
        <div className={"w-full px-4"}>
            <div className={"add-cols-wrapper d-flex flex-column flex-md-row w-100 py-3"}>
                <div
                    className={classNames("col-12 d-flex flex-md-row flex-row-reverse justify-content-between justify-content-md-center ", hideSecondCol ? '' : 'col-md-8 adds-cols-div')}>
