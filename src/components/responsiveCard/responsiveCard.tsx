...
export function ResponsiveCard() {
    return (
        <div className={"d-flex flex-column justify-content-center align-items-center gap-2 responsive-card"}>
            <img alt="card illustration" className={"res-card-dims res-card-img d-none d-md-inline"}
